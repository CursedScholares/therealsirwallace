...
Global("CFKYLEAerieToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLEAerieToB1
~Sister Aerie?~
...
~Pumpkin, be you godless? I don't see you worshipping any gods nor do I see you performing rituals for Sylvanus.~ // casing fixed
DO ~SetGlobal("CFKYLEAnomenToB1","GLOBAL",1)~
== CFKYL25
~I don't worship, but I dabble between two gods.~ // comma
== BANOME25
...
== BANOME25
~And what do they focus on, pumpkin?~ // comma
== CFKYL25
~Well, Chauntea takes care of my family. Helps them grow, gets my baby brothers out of their growing stems in the ground and such.~ // comma
== BANOME25
~Makes sense as she support the work of farmhands. And the other?~
== CFKYL25
~The other is intense. She focuses on the pleasures of life such as the intense dance done in bedchambers and courting of the other sex.~ // hyphen
== BANOME25
...
!StateCheck("CFKYLE",CD_STATE_NOTVALID)
Global("CFKYLECerndToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLECerndToB1
...
== CFKYL25
~I would slice you into the pieces but <CHARNAME> wants you alive. Be grateful. And I'm not a monkey. I'm a pumpkin.~ // stray '
EXIT
...
== BHAERD25
~My elk, keep chanting her name and I will singing of your praise. LEAD ON!~ // there's a grammar issue here 'I will singing'
EXIT
...
!StateCheck("CFKYLE",CD_STATE_NOTVALID)
Global("CFKYLEImoenToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLEImoenToB1
...
!StateCheck("CFKYLE",CD_STATE_NOTVALID)
Global("CFKYLEJaheiraToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLEJaheiraToB1
~So about that husband of yours. Khalid.~ // stray '
...
== CFKYL25
~Tell me more when you can, sister. I'd like to try and be his brother, if only for a few moments.~ // comma
== BJAHEI25
...
!StateCheck("CFKYLE",CD_STATE_NOTVALID)
Global("CFKYLEJanToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLEJanToB1
...
== CFKYL25
~I actually meant no offense. Honestly, the fact that we two are still alive is miraculous.~ // wrong string termination fixed
== BJAN25
...
!StateCheck("CFKYLE",CD_STATE_NOTVALID)
Global("CFKYLEKeldornToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLEKeldornToB1
...
== BKELDO25
~He knew what his kind were subjected to and still protected them with a smile. He died devoting himself to the lands and people he loved. He was good brother Wallace.~ // string improperly terminated fixed
== CFKYL25
~That...was beautiful, Sir....~ // comma
== BKELDO25
...
See("CFKYLE")
!StateCheck("CFKYLE",CD_STATE_NOTVALID)
Global("CFKYLEKorganToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLEKorganToB1
...
== BKORGA25
~Wenches, I understand, but how does it work?~ // comma
== CFKYL25
~I have stem and seeds. It should be obvious.~
== BKORGA25
~It's not.~
== CFKYL25
~You lack imagination, Korgan. I'm shocked. I thought you knew how it works.~ // comma
== BKORGA25
...
!StateCheck("CFKYLE",CD_STATE_NOTVALID)
Global("CFKYLEMazzyToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLEMazzyToB1
...
== BMAZZY25
~Sir Wallace, tis' a kind offer but my sword-arm and my devotion belongs to Arvoreen.~ // typo in Arvoreen
== CFKYL25
...
== BMAZZY25
~I pray that the time comes soon but for now <CHARNAME> needs us. Let us push onwards brother!~ // stray '
EXIT
...
Global("CFKYLENaliaToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLENaliaToB1
...
!StateCheck("CFKYLE",CD_STATE_NOTVALID)
Global("CFKYLESarevokToB2","GLOBAL",0)~ THEN CFKYL25 CFKYLESarevokToB2
...
Global("CFKYLEValygarToB2","GLOBAL",0)~ THEN CFKYL25 CFKYLEValygarToB2
...
Global("CFKYLEViconiaToB1","GLOBAL",0)~ THEN CFKYL25 CFKYLEViconiaToB1
